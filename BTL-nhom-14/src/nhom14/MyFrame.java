...
//		add(tmpPanel, BorderLayout.CENTER);		
	...
	private JPanel createSelectPanel() {
		...
		panelBottom.setBorder(new TitledBorder("Adjacency matrix"));
...
//		panelInputMethodTemp.add(panelDemo);
		...
		JPanel panelUpdateFromGraph = new JPanel(new BorderLayout());
		panelUpdateFromGraph.add(btnUpdate = createButton("Update from graph"), BorderLayout.CENTER);
		panelInputMethodTemp.add(panelOpenInputFile);
		panelInputMethodTemp.add(panelUpdateFromGraph);
...
//	}
	...
	private void actionSaveImage() {
		...
		System.out.println("Save as image");
	}
